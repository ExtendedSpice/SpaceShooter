...
public class BulletOld implements ICollidable,IParticle {
    ...
    public BulletOld(float x, float y, float directionAngle, float vX, float vY, int lifetime, SpaceShip ss)
    {
        coordsX = x;
        coordsY = y;
